...
public class DOPMailTemplateBuilder {
    ...
    public String createTemplateEmail(List<EmailVulnHelper> vulns){
        StringBuffer sb = new StringBuffer();
        sb.append("<html>");
        sb.append("Summary report for trend in detected security vulnerability difference from <b><u>"+vulns.get(0).getTo()+
                "</u></b> to <b><u>"+vulns.get(0).getFrom()+"</u></b> based on automated security test suites.<br/>");
        sb.append("<h2><b>"+vulns.get(0).getProject().getName()+"</b></h2><ul>");
        for (EmailVulnHelper evh : vulns){
