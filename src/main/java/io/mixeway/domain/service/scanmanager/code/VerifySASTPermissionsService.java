...
public class VerifySASTPermissionsService {
    ...
    public SASTRequestVerify verifyIfCodeGroupIsPresent(Optional<CodeGroup> cg, String projectName, boolean depCheck){
    ...
    public SASTRequestVerify returnNotValidRequestWithGroup(Optional<CodeGroup> cg) {
        SASTRequestVerify sastRequestVerify = new SASTRequestVerify();
        sastRequestVerify.setValid(false);
        sastRequestVerify.setCg(cg.get());
        return sastRequestVerify;
