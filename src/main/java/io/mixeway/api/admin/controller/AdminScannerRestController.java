...
public class AdminScannerRestController {
    ...
    public ResponseEntity<Status> addRfw(@PathVariable("id")Long id,
                                         ...
                                         @ApiParam(hidden = true)Principal principal) throws CertificateException, UnrecoverableKeyException, NoSuchAlgorithmException, KeyManagementException, KeyStoreException, IOException {
