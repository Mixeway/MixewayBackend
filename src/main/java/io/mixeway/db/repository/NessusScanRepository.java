...
public interface NessusScanRepository extends JpaRepository<NessusScan, Long>{
	...
	List<NessusScan> findTop5ByRunningOrderByIdAsc(Boolean running);
	...
	List<NessusScan> findByProjectAndRunningOrInQueue(Project project, boolean running, boolean inQueue);
